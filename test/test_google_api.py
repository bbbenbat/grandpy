...
GOOGLE_RES = [{'address_components': [{'long_name': '5', 'short_name': '5', 'types': ['street_number']},
                                      {'long_name': 'Avenue Anatole France', 'short_name': 'Avenue Anatole France',
                                       'types': ['route']},
               ...
               'geometry': {'location': {'lat': 48.85837009999999, 'lng': 2.2944813},
                            ...
                            'viewport': {'northeast': {'lat': 48.8597190802915, 'lng': 2.295830280291502},
